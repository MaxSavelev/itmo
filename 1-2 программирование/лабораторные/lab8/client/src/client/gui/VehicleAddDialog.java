...
/**
 * Диалог ввода данных для добавления Vehicle.
 */
public final class VehicleAddDialog extends JDialog {
    ...
    public VehicleAddDialog(Window owner) {
        this(owner, GuiMessages.forLocale(Locale.forLanguageTag("ru")));
    }

    public VehicleAddDialog(Window owner, GuiMessages messages) {
        super(owner, messages.get("dialog.add.title"), ModalityType.APPLICATION_MODAL);
    ...
    public String getEnginePowerText() {
        return enginePowerField.getText().trim();
    }

    public String getWheelsText() {
        return wheelsField.getText().trim();
    }

    public String getCapacityText() {
        return capacityField.getText().trim();
    }
    ...
    private VehicleInput validateInput() {
        ...
        if (enginePower == null && !getEnginePowerText().isBlank()) {
            return null;
        }
