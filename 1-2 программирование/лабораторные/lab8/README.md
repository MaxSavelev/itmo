...
- Графический интерфейс клиентской части должен поддерживать русский, словенский, французский и испанский (Сальвадор) языки / локали.
...
- Локализованные ресурсы должны храниться в файле свойств.
...
- В функционал клиента должно входить:
  ...
  - Область, визуализирующая объекты коллекции.
...
## Перед непосредственной разработкой приложения необходимо:

- Согласовать прототип интерфейса с преподавателем.
- Создать прототип интерфейса с помощью средства для построения прототипов интерфейсов (mockplus, draw.io и т.д.).
